...
public class NGTurboPage extends NumberGamePage {

    @FindBy(xpath = "//div[contains(@id,'nb-')][1]//div[@class='betGroup-ball']//div[contains(@class,'numberBall')]")
    List<WebElement> elBalls;

    @FindBy(xpath = "//div[contains(@id,'nb-')][1]//span[contains(@class,'bet-time')]")
    WebElement elBetTime;

    @FindBy(xpath = "//div[contains(@id,'nb-')][1]//*[text()='No more bets']")
    WebElement elNoMoreBet;

    public NGTurboPage(WebDriver driver) {
        super(driver);
    }
